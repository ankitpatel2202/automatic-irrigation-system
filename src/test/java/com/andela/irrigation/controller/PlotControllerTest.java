...
public class PlotControllerTest {
    ...
    public void testGetAllPlot(){
        ...
        assert plots != null;
        Assertions.assertEquals(2, plots.size());
    ...
    public void testDeletePlot(){
        System.out.println("Test Delete a Plot");
        ...
        //Delete Plot by id
        String plotUrl = "http://localhost:" + port + "/api/v1/plots/" + plotCreated.getId();
        result = restTemplate.exchange(plotUrl, HttpMethod.DELETE, null, new ParameterizedTypeReference<Object>() {
        });

        Assertions.assertEquals(HttpStatus.NO_CONTENT, result.getStatusCode());
        System.out.println("Completed - Test Delete a plot");
    }
